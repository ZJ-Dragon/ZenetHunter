...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('type', sa.Enum('UNKNOWN', 'ROUTER', 'PC', 'MOBILE', 'IOT', name='devicetypeenum'), nullable=False),
        sa.Column('status', sa.Enum('ONLINE', 'OFFLINE', 'BLOCKED', name='devicestatusenum'), nullable=False),
        sa.Column('active_defense_status', sa.Enum('IDLE', 'RUNNING', 'STOPPED', 'FAILED', name='activedefensestatus'), nullable=False),
        ...
        sa.Column('recognition_manual_override', sa.Boolean(), nullable=False, server_default='0'),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('mac', sa.String(length=17), nullable=False),
        sa.Column('list_type', sa.Enum('WHITELIST', 'BLACKLIST', 'GRAYLIST', name='listtype'), nullable=False),
