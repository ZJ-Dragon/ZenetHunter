...
from app.models.attack import AttackRequest, AttackResponse, AttackStatus, AttackType
...
class AttackService:
    ...
    async def _run_attack_task(self, mac: str, request: AttackRequest):
        ...
        try:
            ...
            logger.info(f"Attack {request.type} running on {mac} for {request.duration}s")
