...
class AttackRequest(BaseModel):
    ...
    type: AttackType = Field(default=AttackType.KICK, description="Type of attack to perform")
    duration: int = Field(default=60, ge=1, le=3600, description="Duration in seconds (for temporary attacks)")
