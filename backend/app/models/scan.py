...
class ScanRequest(BaseModel):
    ...
    type: ScanType = Field(default=ScanType.QUICK, description="Type of scan to perform")
    target_subnets: Optional[List[str]] = Field(None, description="Specific subnets to scan (e.g. 192.168.1.0/24). If None, auto-detect.")
